...
import com.almutlaq.realstate.adapter.SelfReschduledListAdapter
...
class RescheduledServiceFragment @SuppressLint("ValidFragment") constructor
(act: Activity): Fragment() {
    ...
    private var rvRescheduledservice: RecyclerView? = null
    private var myAdapter: SelfReschduledListAdapter? = null
    private var arrayList: ArrayList<CustomerListModel>? = null
    private var layoutManager: RecyclerView.LayoutManager? = null

    var tv_r_no_record : TextView? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val rootview = inflater!!.inflate(R.layout.rescheduledservice_fragment, container, false)
        init(rootview)
        pd!!.show()
        getCustomerRescheduleServiceList()
        //loaddata()
        return rootview
    }

    private fun getCustomerRescheduleServiceList() {
        ...
        if(connectioncheck!!.isNetworkAvailable()) {
            ...
            val resschudelServiceResponseObservable = apiService!!.getCustomerServiceRescheduleList(currentDate,"Bearer "+ login_response!!.data.token)
                        ...
                        override fun onNext(customerServiceListResponse: CustomerServiceListResponse) {
                            ...
                            if (customerServiceListResponse.message_code.equals("1")) {
                                ...
                                if (customerServiceListResponse.data!!.size > 0) {
                                    ...
                                    rvRescheduledservice!!.visibility = View.VISIBLE
                                    tv_r_no_record!!.visibility = View.GONE
                                    myAdapter!!.notifyDataSetChanged()
                                }else{
                                    rvRescheduledservice!!.visibility = View.GONE
                                    tv_r_no_record!!.visibility = View.VISIBLE
                                }
    ...
    private fun init(rootview: View?) {
        ...
        tv_r_no_record  = rootview!!.findViewById(R.id.tv_r_no_record)
        rvRescheduledservice = rootview!!.findViewById(R.id.rvRescheduledservice)
        ...
        myAdapter = SelfReschduledListAdapter(arrayList!!, this!!.activity!!, R.layout.customerservicestatus_row)

        rvRescheduledservice?.layoutManager = LinearLayoutManager(context)
        rvRescheduledservice?.adapter = myAdapter
    }
   ...
   /* private fun loaddata() {
        ...
        arrayList!!.add(SelfRescheduledListModel("AC Maintainance", "Maintaance required",
