...
import com.almutlaq.realstate.adapter.SelfBookedListAdapter
...
class BookedServiceFragment @SuppressLint("ValidFragment") constructor
(act: Activity): Fragment() {
    ...
    private var rvBookedservice: RecyclerView? = null
    private var myAdapter: SelfBookedListAdapter? = null
    private var arrayList: ArrayList<CustomerListModel>? = null

    private var layoutManager: RecyclerView.LayoutManager? = null

    var tv_b_no_record : TextView? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val rootview = inflater!!.inflate(R.layout.bookedservice_fragment, container, false)
        init(rootview)
        pd!!.show()
        getCustomerBookServiceList()
        //loaddata()
        return rootview
    }

    private fun getCustomerBookServiceList() {
        ...
        if(connectioncheck!!.isNetworkAvailable()) {
            ...
            val bookedServiceResponseObservable = apiService!!.getCustomerServiceList(currentDate,"Bearer "+ login_response!!.data.token)

            bookedServiceResponseObservable.subscribeOn(Schedulers.io())
                        ...
                        override fun onNext(customerServiceListResponse: CustomerServiceListResponse) {
                            ...
                            if (customerServiceListResponse.message_code.equals("1")) {
                                ...
                                if (customerServiceListResponse.data!!.size > 0) {
                                    ...
                                    rvBookedservice!!.visibility = View.VISIBLE
                                    tv_b_no_record!!.visibility = View.GONE
                                    myAdapter!!.notifyDataSetChanged()
                                }else{
                                    rvBookedservice!!.visibility = View.GONE
                                    tv_b_no_record!!.visibility = View.VISIBLE
                                }
    ...
    private fun init(rootview: View?) {
        ...
        tv_b_no_record  = rootview!!.findViewById(R.id.tv_b_no_record)

        rvBookedservice = rootview!!.findViewById(R.id.rvBookedservice)
        ...
        myAdapter = SelfBookedListAdapter(arrayList!!, this!!.activity!!, R.layout.customerservicestatus_row)

        rvBookedservice?.layoutManager = LinearLayoutManager(context)
        rvBookedservice?.adapter = myAdapter
    }
...
/*private fun loaddata() {
    ...
    arrayList!!.add(SelfBookedListModel("AC Maintainance", "Maintaance required",
